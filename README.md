# RisuAI 포크판 (해적리스)
이 리포지토리는 RisuAI의 포크판입니다. 제가 원하는 기능을 자유롭게 추가하고 있습니다. 


## 개발 방향
  
본래의 RisuAI 커밋 내용을 100% 이 포크에다가 병합하는 방식을 취하고 있습니다. 

사실상 편의 기능 위주로 추가할 거임

대부분 바이브 코딩 위주로 작업하고 있음

기존 리스와 100% 호환성을 가질거임 즉, 이 포크에서만 작동하는 봇, 프롬 같은거는 없다는 거임
...
- DB 저장 및 불러오기 속도 개선
- PWA 기능 추가
- 노드서버 환경에서 기기간 데이터베이스 충돌방지 기능 추가
- 기타 등등
