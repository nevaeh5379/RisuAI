    ...
    const insertContent = (
        ...
        if (sel) {
            ...
            if (type === "autoComplete") {
                contentStart = contentStart.substring(
                    0,
                    contentStart.lastIndexOf("{{"),
                );
        ...
        if (autocompleteContents.length >= 1) {
            switch (e.key) {
                case "ArrowDown":
                    ...
                    return;
                case "ArrowUp":
                    selectingAutoComplete = Math.max(
                        selectingAutoComplete - 1,
                        0,
                    );
                    e.preventDefault();
...
{:else}
    <div
        ...
        class:text-sm={size === "sm" ||
            (size === "default" && $textAreaTextSize === 1)}
        class:text-md={size === "md" ||
            (size === "default" && $textAreaTextSize === 2)}
        class:text-lg={size === "lg" ||
            (size === "default" && $textAreaTextSize === 3)}
        class:text-xl={size === "xl"}
        class:text-xs={size === "xs" ||
            (size === "default" && $textAreaTextSize === 0)}
        class:w-full={fullwidth}
        class:h-20={height === "20" ||
            (height === "default" && $textAreaSize === -5)}
        class:h-24={height === "24" ||
            (height === "default" && $textAreaSize === -4)}
        class:h-28={height === "28" ||
            (height === "default" && $textAreaSize === -3)}
        class:h-32={height === "32" ||
            (height === "default" && $textAreaSize === -2)}
        class:h-36={height === "36" ||
            (height === "default" && $textAreaSize === -1)}
        ...
        class:min-h-20={height === "20" ||
            (height === "default" && $textAreaSize === -5)}
        class:min-h-24={height === "24" ||
            (height === "default" && $textAreaSize === -4)}
        class:min-h-28={height === "28" ||
            (height === "default" && $textAreaSize === -3)}
        class:min-h-32={height === "32" ||
            (height === "default" && $textAreaSize === -2)}
        class:min-h-36={height === "36" ||
            (height === "default" && $textAreaSize === -1)}
