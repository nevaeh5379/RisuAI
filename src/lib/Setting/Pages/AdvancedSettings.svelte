...
<NumberInput
    ...
    min={0}
    max={20}
    bind:value={DBState.db.loreBookDepth}
/>
...
<NumberInput
    ...
    min={0}
    max={4096}
    bind:value={DBState.db.loreBookToken}
/>
...
<NumberInput
    ...
    size={"sm"}
    min={0}
    bind:value={DBState.db.autoContinueMinTokens}
/>

<span class="text-textcolor"
    >{language.additionalPrompt} <Help key="additionalPrompt" /></span
>
<TextInput
    marginBottom={true}
    size={"sm"}
    bind:value={DBState.db.additionalPrompt}
/>
...
<TextInput
    marginBottom={true}
    size={"sm"}
    bind:value={DBState.db.descriptionPrefix}
/>

<span class="text-textcolor"
    >{language.emotionPrompt} <Help key="emotionPrompt" /></span
>
<TextInput
    marginBottom={true}
    size={"sm"}
...
<span class="text-textcolor"
    >{language.presetChain} <Help key="presetChain" /></span
>
<TextInput
    marginBottom={true}
    size={"sm"}
...
<span class="text-textcolor"
    >{language.requestretrys} <Help key="requestretrys" /></span
>
<NumberInput
    marginBottom={true}
    size={"sm"}
    min={0}
    max={20}
    bind:value={DBState.db.requestRetrys}
/>
...
<NumberInput
    marginBottom={true}
    size={"sm"}
    bind:value={DBState.db.assetMaxDifference}
/>

<span class="text-textcolor mt-4"
    >Vision Quality <Help key="gptVisionQuality" /></span
>
...
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.enableLogExport}
        name={language.enableLogExport}
    ></Check>
</div>
<div class="flex items-center mt-4">
    <Check bind:check={DBState.db.useSayNothing} name={language.sayNothing}>
        <Help key="sayNothing" /></Check
    >
</div>
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.showUnrecommended}
        name={language.showUnrecommended}
    >
...
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.imageCompression}
        name={language.imageCompression}
    >
...
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.useExperimental}
        name={language.useExperimental}
    >
...
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.sourcemapTranslate}
        name={language.sourcemapTranslate}
    >
        <Help key="sourcemapTranslate" /></Check
    >
</div>
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.forceProxyAsOpenAI}
        name={language.forceProxyAsOpenAI}
    >
...
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.legacyMediaFindings}
        name={language.legacyMediaFindings}
    >
...
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.autofillRequestUrl}
        name={language.autoFillRequestURL}
    >
...
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.autoContinueChat}
        name={language.autoContinueChat}
    >
...
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.removeIncompleteResponse}
        name={language.removeIncompleteResponse}
    ></Check>
</div>
<div class="flex items-center mt-4">
...
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.noWaitForTranslate}
        name={language.noWaitForTranslate}
    />
</div>
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.newImageHandlingBeta}
        name={language.newImageHandlingBeta}
    />
</div>
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.allowAllExtentionFiles}
        name="Allow all in file select"
    />
</div>
{#if DBState.db.useExperimental}
    <div class="flex items-center mt-4">
        <Check
            bind:check={DBState.db.putUserOpen}
            name={language.oaiRandomUser}
        >
    ...
    <div class="flex items-center mt-4">
        <Check
            bind:check={DBState.db.googleClaudeTokenizing}
            name={language.googleCloudTokenization}
        >
    ...
    <div class="flex items-center mt-4">
        <Check
            bind:check={DBState.db.automaticCachePoint}
            name={language.automaticCachePoint}
        >
    ...
    <div class="flex items-center mt-4">
        <Check
            bind:check={DBState.db.chatCompression}
            name={language.experimentalChatCompression}
        >
            <Help key="experimentalChatCompressionDesc" /><Help
                key="experimental"
            />
        </Check>
    </div>
...
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.removePunctuationHypa}
        name={language.removePunctuationHypa}
    >
...
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.enableDevTools}
        name={language.enableDevTools}
    ></Check>
</div>
{#if isNodeServer || isTauri}
    <div class="flex items-center mt-4">
        <Check
            bind:check={DBState.db.promptInfoInsideChat}
            name={language.promptInfoInsideChat}
        >
    ...
    {#if DBState.db.promptInfoInsideChat}
        <div class="flex items-center mt-4">
            <Check
                bind:check={DBState.db.promptTextInfoInsideChat}
                name={language.promptTextInfoInsideChat}
            ></Check>
        </div>
    {/if}
{/if}
...
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.checkCorruption}
        name={language.checkCorruption}
    ></Check>
</div>
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.realmDirectOpen}
        name={language.realmDirectOpen}
    >
...
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.returnCSSError}
        name={language.returnCSSError}
    ></Check>
</div>
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.antiServerOverloads}
        name={language.antiServerOverload}
    ></Check>
</div>
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.claude1HourCaching}
        name={language.claude1HourCaching}
    ></Check>
</div>
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.claudeBatching}
        name={language.claudeBatching}
    >
        <Help key="experimental" />
    </Check>
</div>
...
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.rememberToolUsage}
        name={language.rememberToolUsage}
    ></Check>
</div>
<div class="flex items-center mt-4">
    <Check bind:check={DBState.db.enableBookmark} name={language.bookmark}
    ></Check>
</div>
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.simplifiedToolUse}
        name={language.simplifiedToolUse}
    ></Check>
</div>
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.useTokenizerCaching}
        name={language.useTokenizerCaching}
    ></Check>
</div>
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.pluginDevelopMode}
        name={language.pluginDevelopMode}
    ></Check>
</div>
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.studioMode}
        name={language.studioMode}
    ></Check>
</div>
{#if DBState.db.useExperimental}
    <div class="flex items-center mt-4">
        <Check
            bind:check={DBState.db.useExperimentalGoogleTranslator}
            name={"New Google Translate Experimental"}
        >
    ...
    <div class="flex items-center mt-4">
        <Check
            bind:check={DBState.db.claudeRetrivalCaching}
            name={language.claudeCachingRetrival}
        >
            <Help key="unrecommended" unrecommended />
        </Check>
    </div>
...
{#if DBState.db?.account?.useSync}
    <div class="flex items-center mt-4">
        <Check
            bind:check={DBState.db.lightningRealmImport}
            name={"Lightning Realm Import"}
        >
            <Help key="experimental" />
        </Check>
    </div>
...
{#if DBState.db.dynamicAssets}
    <div class="flex items-center mt-4">
        <Check
            bind:check={DBState.db.dynamicAssetsEditDisplay}
            name={language.dynamicAssetsEditDisplay}
        >
...
{#if DBState.db.showUnrecommended}
    <div class="flex items-center mt-4">
        <Check
            bind:check={DBState.db.usePlainFetch}
            name={language.forcePlainFetch}
        >
    ...
    <div class="flex items-center mt-4">
        <Check
            bind:check={DBState.db.showDeprecatedTriggerV1}
            name={language.showDeprecatedTriggerV1}
        >
            <Help key="unrecommended" unrecommended /></Check
        >
    </div>
{/if}
...
<Arcodion styled name={language.banCharacterset}>
    {#each characterSets as set}
        <Button
            styled={DBState.db.banCharacterset.includes(set)
                ? "primary"
                : "outlined"}
            onclick={(e) => {
                if (DBState.db.banCharacterset.includes(set)) {
                    DBState.db.banCharacterset =
                        DBState.db.banCharacterset.filter(
                            (item) => item !== set,
                        );
                } else {
        ...
        >
            {new Intl.DisplayNames([navigator.language, "en"], {
                type: "script",
            }).of(set)} ({characterSetsPreview[set]})
        </Button>
    {/each}
</Arcodion>
    ...
    <Button
        ...
        onclick={(e) => {
            if (DBState.db.customModels[index].flags.includes(flag)) {
                DBState.db.customModels[index].flags = DBState.db.customModels[
                    index
        ...
        styled={DBState.db.customModels[index].flags.includes(flag)
            ? "primary"
            : "outlined"}
    >
        {name}
        ...
        <div class="flex flex-col mt-2">
            ...
            >
                ...
                <div class="flex items-center gap-1">
                    ...
                    <Button
                        ...
                        onclick={(e) => {
                            e.stopPropagation();
                            if (index === DBState.db.customModels.length - 1)
                                return;
                            let models = DBState.db.customModels;
                            let temp = models[index];
                            models[index] = models[index + 1];
            ...
            {#if openedModels.has(model.id)}
                ...
                >
                    ...
                    <TextInput
                        size={"sm"}
                        bind:value={DBState.db.customModels[index].name}
                    />
                    <span class="text-textcolor"
                        >{language.proxyRequestModel}</span
                    >
                    <TextInput
                        size={"sm"}
                        bind:value={DBState.db.customModels[index].internalId}
                    />
                    <span class="text-textcolor">URL</span>
                    <TextInput
                        size={"sm"}
                        bind:value={DBState.db.customModels[index].url}
                    />
                    <span class="text-textcolor">{language.tokenizer}</span>
                    <SelectInput
                        size={"sm"}
                        value={DBState.db.customModels[
                            index
                        ].tokenizer.toString()}
                        onchange={(e) => {
                    ...
                    <SelectInput
                        ...
                        onchange={(e) => {
                            DBState.db.customModels[index].format = parseInt(
                                e.currentTarget.value,
                            );
                        }}
                    >
                    ...
                    <TextInput
                        size={"sm"}
                        bind:value={DBState.db.customModels[index].key}
                    />
                    <span class="text-textcolor"
                        >{language.additionalParams}</span
                    >
                    <TextInput
                        size={"sm"}
...
<div class="flex items-center mt-4">
    <Check
        bind:check={DBState.db.titleGeneration.enabled}
        name={language.titleGeneration}
    />
</div>
