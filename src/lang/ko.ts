export const languageKorean = {
    ...
    "globalNote": "글로벌 노트",
    "autoSuggest": "자동 제안",
    "enableAutoSuggest": "자동 제안 활성화",
    "autoSuggestPrefix": "자동 제안 접두사",
    "autoSuggestClean": "제안 정리 (괄호 제거)",
    ...
    "lorebookPlusTest": "임베딩 테스트",
    "lorebookPlusTestResults": "로어북+ 테스트 결과",
    "lorebookPlusThreshold": "유사도 임계값",
    "lorebookPlusMaxResults": "최대 임베딩 결과",
    "rerankerSettings": "Reranker 설정",
    "rerankerEnabled": "Reranker 활성화",
    "rerankerUrl": "Reranker API URL",
    "rerankerKey": "Reranker API 키",
    "rerankerModel": "Reranker 모델",
    "rerankerTopK": "Reranker Top K",
    "lorebookPlusMaxTokens": "최대 토큰 (임베딩)",
    "rerankerMaxTokens": "최대 토큰 (Reranker)",
};
